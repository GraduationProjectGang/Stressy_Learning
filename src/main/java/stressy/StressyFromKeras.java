...
//                }
    ...
    static void ShuffleTrainTest() {
        ...
        INDArray normalized_train_data = train_data_ind.mul(2).div(STD_MAX).sub(-1);
        INDArray normalized_test_data = test_data_ind.mul(2).div(STD_MAX).sub(-1);
...
//        MultiLayerNetwork stressy_keras = KerasModelImport.importKerasSequentialModelAndWeights(modelByteStream, true);
        ...
        File locationToLoad = new File("src/main/resources/stressy_weights_copy.zip");
        MultiLayerNetwork stressy_keras = ModelSerializer.restoreMultiLayerNetwork(locationToLoad, false);
...
//                stressy_keras.fit(train_iter);
                ...
                while (test_iter.hasNext()) {
                    ...
                    INDArray predicted = stressy_keras.output(features, true);
                ...
                if (last_accuracy < eval.accuracy()) {
                    ...
                    File locationToSave = new File("src/main/resources/stressy_from_keras_3.zip");
